  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-center text-[#00008B] mb-8">Deposit Funds</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="deposit_type" className="block text-sm font-medium text-gray-700 mb-1">
              Deposit Type
            </label>
            <select
              id="deposit_type"

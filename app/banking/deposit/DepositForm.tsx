...
export default function DepositForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await apiClient.request('/banking/deposits/', {
        method: 'POST',
        body: JSON.stringify({
      ...
      setError(err.message || 'An error occurred while processing the deposit');
      ...
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-6">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4">
            <span className="bg-gradient-to-r from-blue-600 to-indigo-700 bg-clip-text text-transparent">Secure Deposit</span>
          </h1>
          <p className="text-lg text-gray-600 max-w-md mx-auto">
            Add funds to your account with our secure deposit system
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6">
            ...
            <p className="text-blue-100 mt-1">Enter your deposit details below</p>
          </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="deposit_type" className="block text-sm font-medium text-gray-700 mb-2">
                    Deposit Type
                  </label>
                  <div className="relative">
                    <select
                    ...
                    >
                      ...
                      <option value="loan deposit">Loan Deposit</option>
                    </select>
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">Your deposit is encrypted and securely processed</p>
                </div>
              </div>
            </div>
          </div>
